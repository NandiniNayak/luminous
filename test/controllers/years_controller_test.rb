...
class YearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create year" do
    assert_difference('Year.count') do
      post years_url, params: { year: { name: @year.name, section: @year.section, user_id: @year.user_id, year_group: @year.year_group } }
    end
  ...
  test "should update year" do
    patch year_url(@year), params: { year: { name: @year.name, section: @year.section, user_id: @year.user_id, year_group: @year.year_group } }
